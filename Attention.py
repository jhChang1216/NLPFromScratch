import numpy as np
from common.time_layers import TimeSoftmaxWithLoss, TimeLSTM, TimeAffine, TimeEmbedding
from github_source.ch08.attention_layer import AttentionWeight, WeightSum
